        ...
        children: <Widget>[
          ...
          InkWell(
            ...
            child: ListTile(
              ...
              title: Text('صفحه‌اصلی', style: theme.textTheme.bodyMedium),
            ),
          ),
          InkWell(
            onTap: () {
            ...
            child: ListTile(
              ...
              title: Text('پروفایل', style: theme.textTheme.bodyMedium),
            ),
          ),
          InkWell(
            onTap: () {
            ...
            child: ListTile(
              ...
              title: Text('پنل مدرسان', style: theme.textTheme.bodyMedium),
            ),
          ),
          InkWell(
            onTap: () {
            ...
            child: ListTile(
              ...
              title: Text('پشتیبانی', style: theme.textTheme.bodyMedium),
            ),
          ),
          InkWell(
            onTap: () {
